...
var Input = function (_React$Component) {
  ...
  _createClass(Input, [{
    ...
    value: function renderSelect(id, props) {
      props.id = id;
      return _react2.default.createElement('select', props, this.props.children);
    }
  }, {
    key: 'renderDefault',
    ...
    value: function renderSet(id, props) {
      return _react2.default.createElement('div', { className: 'control' }, this.props.children);
    }
  }, {
    key: 'render',
...
var InputGroup = exports.InputGroup = function (_React$Component2) {
  ...
  _createClass(InputGroup, [{
    ...
    value: function makeInput(id, props) {
      ...
      switch (props.type) {
        ...
        default:
          ...
          return _react2.default.createElement('div', { className: 'control' }, _react2.default.createElement(Input, props));
      }
    }
  }, {
    key: 'hasOwnLabel',
    ...
    value: function renderWithoutLabel(id, props) {
      return _react2.default.createElement('div', { className: 'group' }, _react2.default.createElement('div', { className: 'control' }), this.makeInput(id, props));
    }
  }, {
    key: 'renderWithLabel',
    value: function renderWithLabel(id, props) {
      delete props.label;
      return _react2.default.createElement('div', { className: 'group' }, _react2.default.createElement('label', { htmlFor: id }, this.props.label), this.makeInput(id, props));
    }
  }, {
    key: 'render',
    value: function render() {
...
var Menu = function (_React$Component) {
  ...
  _createClass(Menu, [{
    key: "render",
    value: function render() {
      return _react2.default.createElement("nav", { className: "menu", role: "menu" }, _react2.default.createElement("ul", null, this.props.children));
    }
  }]);
...
var MenuItem = exports.MenuItem = function (_React$Component2) {
  ...
  _createClass(MenuItem, [{
    ...
    value: function render() {
      var header = void 0,
          dropdown = void 0;
      var title = _react2.default.createElement("span", { key: "title" }, this.props.title);
      if (this.props.children && this.props.children.length) {
        header = [title, ' ', _react2.default.createElement("span", { className: "caret", key: "real-caret" })];
        dropdown = _react2.default.createElement("ul", { key: "real-dropdown", className: this.props.disabled ? 'disabled' : this.props.active ? 'active' : '' }, this.props.children);
      } else {
        header = title;
        dropdown = _react2.default.createElement("span", { key: "dropdown" });
      }
      return _react2.default.createElement("li", null, [_react2.default.createElement("a", { href: "#", onClick: this.onClick, key: "link" }, header), dropdown]);
    }
  }]);
...
var MenuSeparator = exports.MenuSeparator = function (_React$Component3) {
  ...
  _createClass(MenuSeparator, [{
    key: "render",
    value: function render() {
      return _react2.default.createElement("li", null, _react2.default.createElement("span", { className: "divider" }));
    }
  }]);
...
var Window = function (_React$Component) {
  ...
  _createClass(Window, [{
    key: "render",
    value: function render() {
      var minButton = this.props.onMinimize ? _react2.default.createElement("button", { key: "min-btn" }, _react2.default.createElement("i", { className: "fa fa-fw fa-minus fa-fw", onClick: this.props.onMinimize })) : _react2.default.createElement("span", { key: "min-span" });
      var maxButton = this.props.onMaximize ? _react2.default.createElement("button", { key: "max-btn" }, _react2.default.createElement("i", { className: "fa fa-fw fa-" + (this.props.maximized ? 'clone' : 'square-o') + " fa-flip-horizontal fa-fw", onClick: this.props.onMaximize })) : _react2.default.createElement("span", { key: "max-span" });
      var closeButton = this.props.onClose ? _react2.default.createElement("button", { key: "close-btn", className: "danger" }, _react2.default.createElement("i", { className: "fa fa-fw fa-times fa-fw", onClick: this.props.onClose })) : _react2.default.createElement("span", { key: "close-span" });
      return _react2.default.createElement("div", { className: "window" }, [_react2.default.createElement("header", { key: "header" }, [_react2.default.createElement("div", { className: "top", key: "header-top" }, [_react2.default.createElement("h1", { key: "title" }, this.props.title), _react2.default.createElement("div", { className: "button-group", key: "buttons" }, [minButton, maxButton, closeButton])]), this.props.menu ? this.props.menu : _react2.default.createElement("span", { key: "menu" })]), _react2.default.createElement("div", { className: "content", key: "content" }, this.props.children), _react2.default.createElement("footer", { key: "footer" }, this.props.footer)]);
    }
  }]);
...
var menu = _react2.default.createElement(
  _index.Menu,
  { key: 'main-menu' },
  _react2.default.createElement(_index.Menu.Item, { title: 'Menu 1' }),
  _react2.default.createElement(_index.Menu.Item, { title: 'Menu 2' }),
  _react2.default.createElement(_index.Menu.Item, { title: 'Menu 3' }),
  _react2.default.createElement(_index.Menu.Separator, null),
  _react2.default.createElement(
    _index.Menu.Item,
    { title: 'Menu 4' },
    _react2.default.createElement(_index.Menu.Item, { title: 'Menu 4-1' }),
    _react2.default.createElement(_index.Menu.Item, { title: 'Menu 4-2' }),
    _react2.default.createElement(_index.Menu.Item, { title: 'Menu 4-3' }),
    _react2.default.createElement(_index.Menu.Separator, null),
    _react2.default.createElement(
      _index.Menu.Item,
      { title: 'Menu 4-4' },
      _react2.default.createElement(_index.Menu.Item, { title: 'Menu 4-4-1' }),
      _react2.default.createElement(_index.Menu.Item, { title: 'Menu 4-4-2' }),
      _react2.default.createElement(_index.Menu.Item, { title: 'Menu 4-4-3' })
    )
  )
);
...
function toogleMinimizer() {
  ...
  (0, _reactDom.render)(_react2.default.createElement(
    _index.Window,
    { title: 'Starlight-React demo', onClose: closeWindow,
      onMaximize: toogleMinimizer, maximized: maximized, menu: menu },
    _react2.default.createElement(
      'form',
      null,
      _react2.default.createElement(_index.Input.Group, { type: 'text', name: 'user', label: 'Username' }),
      _react2.default.createElement(_index.Input.Group, { type: 'password', name: 'password', label: 'Password' }),
      _react2.default.createElement(_index.Input.Group, { type: 'email', name: 'email', label: 'Email' }),
      _react2.default.createElement(_index.Input.Group, { type: 'date', name: 'birthday', label: 'Birthday' }),
      _react2.default.createElement(_index.Input.Group, { type: 'number', name: 'a-number', label: 'Favourite Number', min: 0, max: 100 }),
      _react2.default.createElement(_index.Input.Group, { type: 'color', name: 'color', label: 'Favourite Color' }),
      _react2.default.createElement(_index.Input.Group, { type: 'range', name: 'range', label: 'A range' }),
      _react2.default.createElement(
        _index.Input.Group,
        { type: 'select', name: 'element', label: 'Best Element' },
        _react2.default.createElement(
          'option',
          null,
          'Water'
      ...
      _react2.default.createElement(_index.Input.Group, { type: 'textarea', name: 'more-text', label: 'Somthing else', value: 'I\'m feeling...\\n totally rad!' }),
      _react2.default.createElement(_index.Input.Group, { type: 'checkbox', name: 'spam', label: 'Send spam?' }),
      _react2.default.createElement(
        _index.Input.Group,
        { type: 'set', label: 'Choose one' },
        _react2.default.createElement(_index.Input, { type: 'radio', name: 'a-radio', label: 'A', checked: true }),
        _react2.default.createElement(_index.Input, { type: 'radio', name: 'a-radio', label: 'B' }),
